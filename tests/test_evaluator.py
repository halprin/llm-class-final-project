...
class TestEvaluator:
    ...
    def test_evaluate_single_datapoint(
        ...
        dataset = [
            {"prompt": "What are my goals?", "expected": "Your goals are important."}
        ]
    ...
    def test_evaluate_multiple_datapoints(
        ...
        actual_calls_db = [
            call for call in mock_database.retrieve_documents.call_args_list
        ]
        ...
        mock_metric.compute.assert_called_once_with(
            ...
            references=[
                "Your goals include completing the project and exercising daily.",
